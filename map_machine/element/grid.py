...
from map_machine.osm.osm_reader import OSMData, OSMMember, OSMNode, OSMRelation, OSMWay, Tags
...
class Grid:
	...
	def draw(self, output_path: Path) -> None:
		...
		constructor: Constructor = Constructor(self.osm_data, flinger, SHAPE_EXTRACTOR, configuration)
